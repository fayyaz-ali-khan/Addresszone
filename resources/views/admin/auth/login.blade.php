                                    ...
                                    <div class="col-lg-7 align-self-center">
                                        <div class="p-3">
                                            ...
                                            <form action="" method="post">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="floating-label form-group">
                                                            <input name="ksdkfjs" class="floating-input form-control"
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="floating-label form-group">
                                                            <input name="password" autocomplete="off" value="ss"
                                                ...
                                                <p class="mt-3">
                                                    Create an Account <a href="auth-sign-up.html" class="text-primary">Sign
                                                        Up</a>
                                                </p>
                                            </form>
                                        </div>
