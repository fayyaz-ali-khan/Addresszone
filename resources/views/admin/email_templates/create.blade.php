...
@section('main-content')
    <x-Admin.Shared.form-page-container title="Add New Email Template">
        <form id="email-template-form" action="{{ route('admin.email_templates.store') }}" method="POST"
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control mb-3">
                            ...
                            @foreach ($templates_categories as $key => $value)
