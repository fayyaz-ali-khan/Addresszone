        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li
                    ...
                    <ul id="blogs"
                        class="iq-submenu collapse {{ request()->routeIs('admin.blogs.*') || request()->routeIs('admin.blog-categories.*') || request()->routeIs('admin.comments.*') ? 'show' : '' }} "
                        data-parent="#iq-sidebar-toggle">
                        <li class="">
                        ...
                        <li class="">
                            <a href="{{ route('admin.comments.index') }}" class="">
                                <i class="las la-minus"></i><span>Comments</span>
                            </a>
                        </li>
