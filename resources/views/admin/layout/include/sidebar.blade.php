        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ request()->routeIs('admin.addresses.*') ? 'active' : '' }} ">
                    <a href="#address" class="collapsed" data-toggle="collapse" aria-expanded="false">
                    ...
                    <ul id="address"
                        class="iq-submenu collapse {{ request()->routeIs('admin.addresses.*') ? 'show' : '' }}"
                        data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="{{ route('admin.addresses.index') }}">
                                <i class="las la-minus"></i><span>List Address</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('admin.addresses.create') }}">
                                <i class="las la-minus"></i><span>Add Address</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('admin.addresses.index') }}">
                                <i class="las la-minus"></i><span>List Location</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('admin.addresses.index') }}">
                                <i class="las la-minus"></i><span>Add Location</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="{{ request()->routeIs('admin.bank_accounts.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.bank_accounts.index') }}" class="collapsed" aria-expanded="false">
                        <svg class="svg-icon" id="p-dash5" width="20" height="20"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="1" y="4" width="22" height="16" rx="2" ry="2">
